...
float timeConst; // [(1/pubVelRate)s]
...
void setParams()
{
  ...
  timeConst = -0.6 / (float) pubVelRate;
...
void readUserInput()
{
  if(stringComplete)
  {
    ...
    else if(inputString.substring(0,2) == "pkp")
    {
      Serial.print("kp: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          kp[0][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'kp'
    ...
    else if(inputString.substring(0,2) == "pki")
    {
      Serial.print("ki: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          ki[0][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'ki'
    ...
    else if(inputString.substring(0,2) == "pkd")
    {
      Serial.print("kd: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          kd[0][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'kd'
    ...
    else if(inputString.substring(0,2) == "vkp")
    {
      Serial.print("kp: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          kp[1][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'kp'
    ...
    else if(inputString.substring(0,2) == "vki")
    {
      Serial.print("ki: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          ki[1][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'ki'
    ...
    else if(inputString.substring(0,2) == "vkd")
    {
      Serial.print("kd: ");
      for(int i=0; i < numMtrs; i++)
      {
        if(mtrEnable[i])
          kd[1][i] = inputString.substring(2, inputString.length()).toFloat(); // get string after 'kd'
...
void controlPos()
{
  ...
  for(int i=0; i < numMtrs; i++)
  {
    if(mtrEnable[i])
    {
      ...
      P[i] = (long) round( kp[0][i] * errs[i] ); // P(t_k) = K(by_{sp}(t_k) — y(t_k))
      Serial.print("P[");
      Serial.print(i);
      Serial.print("] = kp[0][");
      Serial.print(i);
  ...
  //      I[i] = 0;
  //
      D[i] = (long) round( kd[0][i] * ( ( angPos[i] - prevAngPos[i] ) / degsPerRad * 256 ) ); // large when amount of change requested by PID controller is large, and small as signal approaches zero
      Serial.print("D[");
      Serial.print(i);
      Serial.print("] = kd[0][");
      Serial.print(i);
...
//      I[i] = 0;
    ...
    D[i] = (long) round( kd[1][i] * ( ( angVels[i] - prevAngVels[i] ) / degsPerRad * 256 ) ); // large when amount of change requested by PID controller is large, and small as signal approaches zero
