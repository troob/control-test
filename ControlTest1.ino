/* NOT PRINTING TO SERIAL MONITOR FOR UNKNOWN REASON
 * Control Test
...
void readUserInput()
{
  if(stringComplete)
  {
    ...
    else if(inputString.substring(0,3) == "pkp")
    {
      Serial.print("kp: ");
      for(int i=0; i < numMtrs; i++)
      {
    ...
    else if(inputString.substring(0,3) == "pki")
    {
      Serial.print("ki: ");
      for(int i=0; i < numMtrs; i++)
      {
    ...
    else if(inputString.substring(0,3) == "pkd")
    {
      Serial.print("kd: ");
      for(int i=0; i < numMtrs; i++)
      {
    ...
    else if(inputString.substring(0,3) == "vki")
    {
      Serial.print("ki: ");
      for(int i=0; i < numMtrs; i++)
      {
    ...
    else if(inputString.substring(0,3) == "vkd")
    {
      Serial.print("kd: ");
      for(int i=0; i < numMtrs; i++)
      {
